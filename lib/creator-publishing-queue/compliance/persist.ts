...
const reviewOutcome: Record<ComplianceOutcome, "pass" | "block" | "manual_review"> = { passed: "pass", blocked: "block", manual_review: "manual_review" }
