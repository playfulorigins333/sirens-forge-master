...
const safeErrors: Record<CreatorPublishingApprovalErrorCode, SafeApprovalError> = {
  ...
  APPROVAL_INVALID_DECISION: { code: "APPROVAL_INVALID_DECISION", title: "Invalid decision", message: "The decision could not be saved. No publishing action was taken.", severity: "error", controlsDisabled: true },
