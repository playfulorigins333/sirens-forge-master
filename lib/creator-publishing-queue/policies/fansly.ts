...
export const fanslyPolicy = deepFreezePolicy({
  ...
  source_references: [
    { label: "Fansly Terms of Service", url: "https://fansly.com/tos" },
    { label: "Fansly AI-generated content help article", url: "https://help.fansly.com/" },
    { label: "Fansly co-performer verification help article", url: "https://help.fansly.com/" },
    { label: "Fansly post scheduling help article", url: "https://help.fansly.com/" },
  ],
