    ...
    <>
      ...
      {task14.ok ? (
        ...
        <section className="relative z-10 mx-auto mt-8 max-w-6xl rounded-3xl border border-cyan-300/20 bg-cyan-950/20 p-5 text-cyan-50">
          <p className="text-sm uppercase tracking-[0.25em] text-cyan-200">Publishing plans</p>
          <h2 className="mt-2 text-2xl font-semibold">Publishing plans are temporarily unavailable</h2>
          <p className="mt-2 text-sm text-cyan-100">Existing Autopost tools remain available. Draft Publishing Plans will appear here when your saved package information is available.</p>
        </section>
      )}
    </>
  );
