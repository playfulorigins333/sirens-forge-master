...
export default function ReportIntimateContentPage() {
  return (
    <LegalPageLayout title="Report Nonconsensual Intimate Content / Request Removal" lastUpdated="August 22, 2026">
      ...
      <section><h2 className="text-xl font-semibold">Send a report</h2><p>Reports use our existing manual intake at <a className="text-cyan-400 hover:underline" href="mailto:admin@sirensforge.vip">admin@sirensforge.vip</a>. This page does not submit to an automated case-management system.</p><p><a className="inline-flex rounded-lg bg-cyan-500 px-4 py-2 font-semibold text-black hover:bg-cyan-400" href={mailto}>Open a prefilled email report</a></p></section>
