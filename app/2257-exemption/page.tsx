  ...
  return (
    ...
    >
      ...
      <section>
        ...
        <p>
          Under 18 U.S.C. §2257 and related regulations, record-keeping
          requirements apply to producers of visual depictions of actual sexually
      ...
      <section>
        ...
        <p>
          Sirens Forge strictly prohibits content involving minors, non-consensual
          activity, or unauthorized use of real individuals. Violations may
          result in account termination and reporting where required or
          appropriate.
        </p>
      </section>
