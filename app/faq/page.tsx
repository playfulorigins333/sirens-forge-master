  ...
  return (
    ...
    >
      ...
      <section>
        ...
        <p>
          Sirens Forge supports Text → Image, Text → Video, and Image → Video creation, with an optional AI Twin. Current submission availability is shown in the generator.
        </p>
      </section>
