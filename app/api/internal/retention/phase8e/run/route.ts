...
import { runPhase8eSubscriptionDelinquencyEnforcement } from "@/lib/retention/phase8e";
...
export async function GET(request: Request) {
  ...
  const result = await runPhase8eSubscriptionDelinquencyEnforcement();
  console.info({ event: "phase8e_subscription_delinquency_enforcement_run", ...result });
