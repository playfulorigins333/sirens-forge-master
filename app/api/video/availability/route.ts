...
import { isVideoSourceUploadReady } from "@/lib/video/sourceUpload";
...
export async function GET() {
  ...
  return NextResponse.json({ available, text_to_video: available, image_to_video: available, source_upload_ready: available && isVideoSourceUploadReady(), tier, caps: VIDEO_TIERS[tier], target_fps: VIDEO_TARGET_FPS, target_min_short_edge: VIDEO_TARGET_MIN_SHORT_EDGE }, { headers });
}
