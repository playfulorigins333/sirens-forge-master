...
import { Sparkles, Mail, Lock, Eye, EyeOff, Crown, Star } from "lucide-react"
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white flex items-center justify-center p-4">
      <div className="w-full max-w-6xl grid lg:grid-cols-2 gap-8 items-center">
        ...
        >
          ...
          <p className="text-lg text-gray-400">Create stunning images and videos with advanced AI technology</p>

          <div className="space-y-4">
            <Feature icon={<Sparkles className="w-6 h-6 text-purple-400" />} title="Advanced AI Models" desc="FLUX-powered face & body lock for consistent character generation" />
            <Feature icon={<Crown className="w-6 h-6 text-pink-400" />} title="Premium Features" desc="Access SFW, NSFW, and ULTRA modes" />
            <Feature icon={<Star className="w-6 h-6 text-cyan-400" />} title="Exclusive Access" desc="OG Founders & Early Birds get elite perks" />
          </div>
        </motion.div>
          ...
          <Card className="border-gray-700 bg-gray-800/50 backdrop-blur-sm">
            ...
            <CardContent className="space-y-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  <Label>Email</Label>
                  <Input type="email" className="bg-gray-900 border-gray-700" value={email} onChange={(e) => setEmail(e.target.value)} required />
                </div>
                ...
                <Button disabled={isLoading} className="w-full bg-gradient-to-r from-purple-600 via-pink-600 to-cyan-600 text-white">
              ...
              <div className="text-center text-sm">
                ...
                <button className="text-purple-400" onClick={() => setMode(mode === "login" ? "signup" : "login")}>
