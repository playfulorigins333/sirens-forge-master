...
run(`insert into auth.users values('20000000-0000-4000-8000-000000000004');insert into profiles(id,user_id)values('10000000-0000-4000-8000-000000000004','20000000-0000-4000-8000-000000000004');select payment_v2_claim('${earlyPurchase}',decode(repeat('cd',32),'hex'),'10000000-0000-4000-8000-000000000004','20000000-0000-4000-8000-000000000004');select payment_v2_record_paid_recurring_invoice('${earlyHold}','sub_early','cus_early','in_early_1','evt_early_1','subscription_create',now(),900,'usd')`)
