...
assert.match(autopostPageClient, /posts_per_day: 1/, 'Fanvue UI save path must satisfy the rules route insert schedule contract')
assert.match(autopostPageClient, /time_slots: \["00:00"\]/, 'Fanvue UI save path must include an insert-safe placeholder time slot')
