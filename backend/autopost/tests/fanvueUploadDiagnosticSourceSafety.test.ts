...
const sources = {
  diagnostic: readFileSync('lib/autopost/fanvueUploadDiagnostic.ts', 'utf8'),
  routeHelper: readFileSync('lib/autopost/fanvueUploadDiagnosticRoute.ts', 'utf8'),
  auth: readFileSync('lib/autopost/fanvueUploadDiagnosticAuth.ts', 'utf8'),
  route: readFileSync('app/api/admin/autopost/fanvue/upload-diagnostic/route.ts', 'utf8'),
}
...
console.log('Fanvue upload diagnostic source safety checks passed')
