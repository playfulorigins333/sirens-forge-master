...
await test("no upload, delete, list, move, public bucket, or provider calls are introduced by media signing", () => {
  ...
  const allowedAutopost = new Set(["app/autopost/page.tsx", "app/autopost/AutopostPageClient.tsx", "app/autopost/Task14AutopostOrchestration.tsx", "app/api/autopost/connect/fanvue/callback/route.ts", "app/api/autopost/connect/fanvue/start/route.ts", "app/api/autopost/connect/fanvue/disconnect/route.ts", "app/api/admin/autopost/fanvue/write-creator-reconnect/start/route.ts", "lib/autopost/platformRegistry.ts", "lib/autopost/platformAvailability.ts", "lib/autopost/fanvueOAuth.ts", "lib/autopost/fanvueInternalAdapter.ts", "lib/autopost/fanvueProviderExecutorCore.ts", "lib/autopost/fanvueMediaReadinessConfig.ts", "lib/autopost/fanvueMediaReadinessDiagnostic.ts", "lib/autopost/xAdapter.ts", "lib/autopost/jobResults.ts", "lib/creator-publishing-queue/fanvue/executor.ts", "lib/creator-publishing-queue/fanvue/capability.ts", "lib/creator-publishing-queue/fanvue/history.ts", "app/creator/publishing-queue/fanvue/page.tsx", "lib/creator-publishing-queue/fanvue/service.ts", "lib/creator-publishing-queue/fanvue/serviceCore.ts", "lib/creator-publishing-queue/fanvue/workerCore.ts", "supabase/migrations/20260814090000_cpq_fanvue_launch_execution_foundation.sql"])
