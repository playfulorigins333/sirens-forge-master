...
select pg_temp.assert_true((select platform_requires_ai_disclosure and not platform_blocks_fictional_personas from public.creator_publishing_platform_capabilities where platform='fanvue'),'Fanvue requires disclosure and permits fictional personas');
