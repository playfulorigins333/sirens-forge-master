...
-- Scenarios: claim/release/progress/recovery exact replay; IDEMPOTENCY_CONFLICT changed canonical request; release status restoration; explicit and in-claim expired recovery; mutable drift bypass for release/recovery.
