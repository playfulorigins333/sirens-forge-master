...
\echo TASK17A_SCENARIO_START: safety_manual_result_claim_rejected
select task17a_test.assert_claim_rejected(923030,'manual result evidence blocks claim','OPERATOR_TASK_INELIGIBLE',$$update public.creator_publishing_queue_tasks set posted_confirmation=true where id=($1->>'task')::uuid$$);
