...
declare
  f jsonb;
  v_event uuid := task17a_test.uuid_for('92430000-0000-4000-8000-', seed);
  v_sibling uuid := task17a_test.uuid_for('92431000-0000-4000-8000-', seed);
  v_lock uuid := task17a_test.uuid_for('92432000-0000-4000-8000-', seed);
  v_result jsonb;
...
select task17a_test.assert_terminal_scheduler_superseded(924004,'blocked','blocked',false,'blocked scheduler terminal superseded');
\echo TASK17A_SCENARIO_START: scheduler_terminal_archived_superseded
select task17a_test.assert_terminal_scheduler_superseded(924005,'ready_for_handoff','archived',false,'archived scheduler terminal superseded');
\echo TASK17A_SCENARIO_START: scheduler_terminal_platform_rejected_superseded
select task17a_test.assert_terminal_scheduler_superseded(924006,'ready_for_handoff','platform_rejected',false,'platform rejected scheduler terminal superseded');
\echo TASK17A_SCENARIO_START: scheduler_terminal_confirmed_posted_manual_superseded
select task17a_test.assert_terminal_scheduler_superseded(924007,'ready_for_handoff','confirmed_posted_manual',false,'confirmed posted manual scheduler terminal superseded');
\echo TASK17A_SCENARIO_START: scheduler_terminal_cancelled_superseded
select task17a_test.assert_terminal_scheduler_superseded(924008,'ready_for_handoff','scheduled_internally',true,'cancelled scheduler terminal superseded');

select task17a_test.run_scheduler_transition(924101,'ready_for_handoff','scheduled_internally','operator_due','processed',null,'processed','awaiting_operator','awaiting_operator',true,false,false,'operator_due ready_for_handoff to awaiting_operator');
select task17a_test.run_scheduler_transition(924102,'scheduled_internally','scheduled_internally','operator_due','processed',null,'processed','awaiting_operator','awaiting_operator',true,false,false,'operator_due scheduled_internally to awaiting_operator');
select task17a_test.run_scheduler_transition(924103,'awaiting_operator','awaiting_operator','operator_due','blocked','SCHEDULER_STATE_TRANSITION_INVALID','blocked','awaiting_operator','needs_fix',true,false,true,'operator_due awaiting_operator invalid transition');
select task17a_test.run_scheduler_transition(924104,'due_now','due_now','operator_due','superseded','OBSOLETE_OPERATOR_DUE_SUPERSEDED','superseded','due_now','due_now',false,true,false,'operator_due due_now obsolete superseded');
select task17a_test.run_scheduler_transition(924105,'ready_for_handoff','scheduled_internally','publish_due','processed',null,'processed','due_now','due_now',true,false,false,'publish_due ready_for_handoff to due_now');
select task17a_test.run_scheduler_transition(924106,'scheduled_internally','scheduled_internally','publish_due','processed',null,'processed','due_now','due_now',true,false,false,'publish_due scheduled_internally to due_now');
select task17a_test.run_scheduler_transition(924107,'awaiting_operator','awaiting_operator','publish_due','processed',null,'processed','due_now','due_now',true,false,false,'publish_due awaiting_operator to due_now');
select task17a_test.run_scheduler_transition(924108,'due_now','due_now','publish_due','blocked','SCHEDULER_STATE_TRANSITION_INVALID','blocked','due_now','needs_fix',true,false,true,'publish_due due_now invalid transition');
