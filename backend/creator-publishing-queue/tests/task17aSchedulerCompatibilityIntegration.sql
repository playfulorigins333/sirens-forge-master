...
-- Scenarios: process_scheduler_event operator_due and publish_due preserve claimed ownership/progress; unclaimed ready/scheduled/awaiting/due_now transitions; expired/unauthorized/malformed/duplicate/blocked fail closed.
