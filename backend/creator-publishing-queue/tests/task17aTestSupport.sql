...
begin
  ...
  insert into public.creator_publishing_operator_authorizations(creator_id,operator_id,platform,status,authorized_at) values(v_creator,v_operator_a,'onlyfans','active',v_now),(v_creator,v_operator_b,'onlyfans','active',v_now),(v_creator,v_revoked,'onlyfans','revoked',v_now) on conflict do nothing;
