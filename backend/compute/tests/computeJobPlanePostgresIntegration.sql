...
do $$ declare j uuid; j2 uuid; before_count integer; begin
 ...
 assert (select training_job_id=j and status='queued' from public.user_loras where id='20000000-0000-4000-8000-000000000001');
