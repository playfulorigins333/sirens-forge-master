  ...
  if (isTyping) {
    return (
      <div className="flex justify-start">
        <div className="rounded-[24px] border border-fuchsia-500/15 bg-[linear-gradient(180deg,rgba(12,12,16,0.98),rgba(8,8,12,0.98))] px-5 py-4">
  ...
  if (isAssistant) {
    return (
      <div className="flex min-w-0 justify-start">
        <div
          className={`w-full min-w-0 rounded-[24px] border px-5 py-4 sm:px-6 ${
            isError
        ...
        >
          ...
          <div
            className={`break-words whitespace-pre-wrap text-[15px] leading-8 [overflow-wrap:anywhere] ${
