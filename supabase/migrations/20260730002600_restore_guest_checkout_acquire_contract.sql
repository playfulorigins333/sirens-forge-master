...
revoke execute on function public.acquire_guest_checkout_capacity_reservation(bytea,bytea,text) from public;
revoke execute on function public.acquire_guest_checkout_capacity_reservation(bytea,bytea,text) from anon;
revoke execute on function public.acquire_guest_checkout_capacity_reservation(bytea,bytea,text) from authenticated;
grant execute on function public.acquire_guest_checkout_capacity_reservation(bytea,bytea,text) to service_role;
