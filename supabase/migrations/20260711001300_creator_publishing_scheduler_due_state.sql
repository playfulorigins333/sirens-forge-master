...
begin
 return query with due as (
   ...
   returning e.id,e.lock_token,e.event_status,e.processing_attempts,e.schedule_revision,due.due_at,due.event_order
 ), claim_audits as (
   ...
   select 'creator_publishing_scheduler_event',c.id,'system','creator_publishing_scheduler_event_claimed',jsonb_build_object('event_status','pending'),jsonb_build_object('event_status',c.event_status,'processing_attempts',c.processing_attempts,'schedule_revision',c.schedule_revision),now()
   from claimed c
   returning id
